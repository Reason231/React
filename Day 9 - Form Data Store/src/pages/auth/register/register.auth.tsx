...
export const RegisterPage = () => {
  const [data, setData] = useState({}); // store form data while typing

  const handleChange = (e: BaseSyntheticEvent): void => {
    e.preventDefault(); // It listen the changes made in the values
    const value = e.target.value; // It gives the data after channge
            ...
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6">
                  ...
                  <select
                    id="role"
                    name="role" // It stores the name value
