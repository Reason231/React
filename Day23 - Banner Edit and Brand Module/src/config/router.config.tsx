...
import { AdminBannerList,AdminBannerCreate,AdminBannerEdit } from "../pages/banner/index";
import { AdminBrandList,AdminBrandCreate,AdminBrandEdit } from "../pages/brand/index";
