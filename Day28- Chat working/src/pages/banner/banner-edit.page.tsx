...
const AdminBannerEdit = () => {
  ...
  const submitEvent = async (data: any) => {
    ...
    try {
      ...
      // This is required because if we don't update the image and update the banner wihtout putting the new image, it will continue
          ...
          <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            {
              loading ? <><LoadingComponent /></> : <>
                <form onSubmit={handleSubmit(submitEvent)}>
                  ...
                  {/* Submit button */}
                  <SubmitButton loading={loading as boolean} btnText="Update Banner"></SubmitButton>
