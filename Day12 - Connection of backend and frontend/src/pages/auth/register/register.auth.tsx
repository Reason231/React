...
const RegisterPage = () => {
  ...
  const submitEvent=async(data:any)=>{
      // API call after the submit
      try{
        // it sends to the authsvc file
        // first argument represents the url , second represents the data and third represents the config
        // the url is taken from the backend
        
        const response=await authSvc.postRequest('/auth/reigster',data , {file:true})  
      }
      catch(exception) {
        // handling
